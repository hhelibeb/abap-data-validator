...
CLASS zcx_adv_exception DEFINITION LOCAL FRIENDS ltcl_test.
...
CLASS ltcl_test IMPLEMENTATION.
  METHOD test_direct_text.
    ...
    DATA: lx_ex       TYPE REF TO zcx_adv_exception,
    ...
    TRY.
      ...
      CATCH zcx_adv_exception INTO lx_ex.
    ...
    TRY.
        zcx_adv_exception=>raise( lc_text1 ).
        cl_abap_unit_assert=>fail( ).
      CATCH zcx_adv_exception INTO lx_ex.
    ...
    TRY.
        zcx_adv_exception=>raise( lc_text2 ).
        cl_abap_unit_assert=>fail( ).
      CATCH zcx_adv_exception INTO lx_ex.
        cl_abap_unit_assert=>assert_equals(
          act = get_exc_text( lx_ex )
          exp = zcx_adv_exception=>gc_generic_error_msg ).
    ENDTRY.
